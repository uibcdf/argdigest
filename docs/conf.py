...
version = argdigest_version_file.__version__.split('+')[0]
release = argdigest_version_file.__version__.split('+')[0]
...
htmlhelp_basename = 'argdigestdoc'
